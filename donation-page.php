...
<!-- Mirrored from mannatstudio.com/html/gracious/donation-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Feb 2021 05:26:35 GMT -->
<head>
    <!-- xxx Basics xxx -->
    <meta charset="utf-8">
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col d-flex align-items-center contact-info">
                        <div>
                            <i data-feather="phone"></i>  <a href="tel:9943598392">9943598392</a>
                        </div>
                        <div>
                            <i data-feather="mail"></i>  <a href="mailto:obitauchiha10@gmail.com">gracious@gmail.com</a>
                        </div>
                        ...
                        <div class="donation-wrap">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        <div class="custom-control custom-radio custom-control-inline">
                                            ...
                                            <label class="custom-control-label" for="customRadioInline1">₹100</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="customRadioInline2" name="customRadioInline1" class="custom-control-input">
                                            <label class="custom-control-label" for="customRadioInline2">₹200</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="customRadioInline3" name="customRadioInline1" class="custom-control-input">
                                            <label class="custom-control-label" for="customRadioInline3">₹500</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="customRadioInline4" name="customRadioInline1" class="custom-control-input">
                                            <label class="custom-control-label" for="customRadioInline4">₹1000</label>
                                        </div>
                                         <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="customRadioInline4" name="customRadioInline1" class="custom-control-input">
                                            <label class="custom-control-label" for="customRadioInline4">₹2000</label>
                                        </div>
                                        <div class="custom-control custom-radio custom-control-inline">
                                            <input type="radio" id="customRadioInline5" name="customRadioInline1" class="custom-control-input">
                                            <label class="custom-control-label" for="customRadioInline5">₹5000</label>
                                        </div>
                                ...
                                <div class="col-md-6">
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control" id="phoneno" placeholder="Mobile No">
                                    </div>
                                <div class="col-md-6">
                                    <div class="form-group">
        ...
        <div class="container pos-rel">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>Love is the most durable power in the world.</p>
                    <div class="social-icons">
                    ...
                    <div class="footer-widget-contact">
                        <ul class="list-unstyled">
                            <li>
                                ...
                                <div>SS Colony, Bypass Road, Madurai, Tamilnadu.</div>
                            </li>
                            <li>
                                <div><i data-feather="phone"></i> </div>
                                <div><a href="tel:9943598392">9943598392</a></div>
                            </li>
                            <li>
                                <div><i data-feather="mail"></i> </div>
                                <div><a href="mailto:obitauchiha10@gmail.com">obitauchiha10@gmail.com</a></div>
                            </li>
                            <li>
            ...
            <div class="container pos-rel">
                <div class="row text-md-left text-center">
                    <div class="col-sm-12 col-md-auto copyright-text">
                        © Copyright <span class="txt-blue">Gracious Non-Profit Charity</span> 2021.   |   Created by <a href="https://themeforest.net/user/mannatstudio" rel="nofollow">BGK Studio</a>
                    </div>
...
<!-- Mirrored from mannatstudio.com/html/gracious/donation-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 27 Feb 2021 05:26:36 GMT -->
</html>